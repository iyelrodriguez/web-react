...
const Data = () => {
    return (
      <div className="home__data">
        <h1 className="home__title">Gil Rodriguez
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className = "home__subtitle"  >Your Friendly Neighborhood Software Engineer</h3>
        <p className="home__description">I'm a software engineer/graphic designer located in Philippines and I specialize in
            creating efficient websites and designs to cope up with your
            needs and meet your business goals.</p>
